...
class BinanceMarketMapService {
  ...
  // NATR = (highest - lowest) / lastPrice * 100 over the 5-minute window.
  // Measures volatility (price range), not direction — a coin that spikes +5%
  // then crashes -5% scores high (~10%), unlike directional change which → ~0%.
